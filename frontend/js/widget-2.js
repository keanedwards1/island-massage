!function(e) {
    ...
    var r = {};
    t.m = e, t.c = r, t.i = function(e) { return e }, t.d = function(e, r, n) {
    ...
    4: function(e, t, r) {
        ...
        function n(e) {
            var t = document.querySelector("iframe.yelp-ga-tracker"),
                r = {hitType: "pageview", embedLocation: window.location.host, embedLocationPath: window.location.pathname, embedLocationQuery: window.location.search},
        ...
        function o(e, t, r) {
            ...
            i.setAttribute("data-review-id", r), i.classList.add("yelp-review"), i.src = n, i.scrolling = "no", i.style.display = "block", i.style.maxWidth = "900px", i.style.minWidth = "220px", i.style.width = "100%", i.style.height = "0", i.style.border = "0", i.style.borderRadius = "15px", i.style.opacity = "0.8", e.parentNode && e.parentNode.insertBefore(i, e)
        }
        function a() {
            if (document.querySelectorAll && window.postMessage && window.JSON) {
                ...
                if (e.length) {
                    if (!t) {
                        ...
                        window.addEventListener("message", function(e) { i(e, r) }, !1), t = document.createElement("iframe"), t.classList.add("yelp-ga-tracker"), t.src = r + "/ga", t.style.display = "none", document.body && document.body.appendChild(t)
                    }
